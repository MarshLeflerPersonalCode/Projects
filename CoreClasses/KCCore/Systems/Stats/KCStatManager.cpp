...
bool KCStatManager::initialize()
{
	...
	const KCDBTable<FKCStatDefinition> *pStatTable = (const KCDBTable<FKCStatDefinition> *)getDatabaseManager()->getTable(DATABASE::EDATABASE_TABLES::STATS);
...
const FKCStatDefinition * KCStatManager::getStatDefinitionByID(KCStatID iID) const
{
	...
	KCEnsureAlwaysReturnVal((uint32)iID < m_StatDefinitions.Num(), nullptr);
...
const KCTArray<FKCStatDefinition * > * KCStatManager::getStatDefinitions() const
{
	KCEnsureAlwaysReturnVal(getDatabaseManager(), nullptr);
	const KCDBTable<FKCStatDefinition> *pStatTable = (const KCDBTable<FKCStatDefinition> *)getDatabaseManager()->getTable(DATABASE::EDATABASE_TABLES::STATS);
