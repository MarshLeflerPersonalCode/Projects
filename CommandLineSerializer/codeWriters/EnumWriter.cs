...
namespace CommandLineSerializer.codeWriters
{
	public class EnumWriter : CodeWriter
	{
		...
		public override bool attemptDataGroupWriteCode(HeaderFile mHeaderFile, ClassVariable mVariable, string strDataGroupName)
		{
			...
			mHeaderFile.addLine(strDataGroupName + ".setProperty(\"" + mVariable.variableName + "\", _SERIALIZER_ENUMS_::_getEnumItemNameByValue(" + mEnum.uniqueID.ToString() + ",(int32)" + mVariable.variableName + "));");			
			return true;
		}
		public override bool attemptDataGroupReadCode(HeaderFile mHeaderFile, ClassVariable mVariable, string strDataGroupName)
		{
			...
			mHeaderFile.addLine(mVariable.variableName + " = (" + mEnum.enumName + ")_SERIALIZER_ENUMS_::_getEnumValueByName(" + mEnum.uniqueID.ToString() + "," + strDataGroupName  + ".getProperty(\"" + mVariable.variableName + "\", _SERIALIZER_ENUMS_::_getEnumItemNamesByEnumName(\"" + mEnum.enumName + "\")[(int32)" + mVariable.variableName + "]));");
			return true; 
		}
